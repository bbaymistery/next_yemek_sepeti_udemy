...
const Reservation = () => {
    ...
    const intial = { fullName: "", phoneNumber: "", email: "", persons: "", date: "", }

    const { values, errors, touched, handleSubmit, handleChange, handleBlur } = useFormik({ initialValues: intial, onSubmit, validationSchema: reservationSchema, });
